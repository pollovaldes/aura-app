...
import { useAssignUserRole } from "./AssignRoleLogic";// Adjust the import path accordingly

export default function AssignRole({ closeModal }: { closeModal: () => void }) {
  const { styles } = useStyles(stylesheet);
  const { loading, assignUserRole } = useAssignUserRole();
