  ...
  return (
    <TouchableOpacity
      style={[
        styles.container,
        {
          backgroundColor: selected ? styles.selected.backgroundColor : styles.unselected.backgroundColor,
        },
      ]}
      disabled={disabled}
      onPress={onPress}
    >
      <Text style={[styles.text, { color: selected ? styles.selected.color : styles.unselected.color }]}>
        {caption}
      </Text>
    </TouchableOpacity>
  );
