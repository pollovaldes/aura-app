    ...
    <>
      ...
      >
        <View style={styles.container}>
          ...
          <GroupedList>
            <Row title="Información personal" icon={Info} backgroundColor={colorPalette.cyan[500]} />
          </GroupedList>
          <GroupedList header="Acciones">
            <Row title="Editar rol" icon={SquarePen} backgroundColor={colorPalette.red[500]} />
            <Row title="Asignación de vehículos" icon={Truck} backgroundColor={colorPalette.green[500]} />
          </GroupedList>
        </View>
      </ScrollView>
    </>
