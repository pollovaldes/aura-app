...
export type Database = {
  public: {
    Tables: {
      ...
      route_events: {
        Row: {
          ...
          ended_location: unknown | null;
          event_type: Database["public"]["Enums"]["route_event"];
          id: string;
          route_id: string;
          started_at: string;
          started_location: unknown | null;
        };
        Insert: {
          ended_at?: string | null;
          ended_location?: unknown | null;
    ...
    Enums: {
      ...
      notification_category: "MAINTENANCE" | "GASOLINE" | "ROLE" | "FLEETS" | "ROUTES" | "OTHER";
      role_change_status: "PENDING_REVISION" | "IN_REVISION" | "DENIED" | "ACCEPTED";
      roles: "OWNER" | "ADMIN" | "DRIVER" | "NO_ROLE" | "BANNED";
      route_event: "EMERGENCY" | "FAILURE" | "BREAK" | "REFUELING" | "OTHER";
      user_fleet_add_request_status: "PENDING_REVISION" | "IN_REVISION" | "DENIED" | "ACCEPTED";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
